$(document).ready(function() {
	...
	$('.first-menu .menu-item-has-children > a').on('click', function(e) {
		e.preventDefault();
		var primaryMenu = $(this).parents().eq(3);
		var secondaryMenu = $(this).parents().eq(3).next();
