...
class Lgx_Owl_Carousel_Public {
	...
	public function enqueue_scripts() {
		...
		wp_register_script('owljs', plugin_dir_url( __FILE__ ) . 'assets/lib/owl.carousel2/owl.carousel.js', array( 'jquery' ), $this->version, false );
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'assets/js/lgx-owl-carousel-public.js', array( 'jquery' ), $this->version, false );
	...
	public static function lgx_output_function($params){
		...
		$output .= '<div class="owl-carousel lgx-carousel" ' . $data_attr_str . ' >' . $carousel_item . '</div>';
		$output .= '</div>';
		$output .= '</div>';
		$output .= '</div>';
